...
### day7-数字鸿沟
 ...
 For this part, you are allowed 30 minutes to write an essay that begins with the sentence “P**eople are now increasingly aware o f the "digital gap' or challenges the elderlyface in a digital world.**" You can make comments, give explanations, or cite examples to develop your essay. You should write at least 150 words but no more than 200 words
...
>
>例如，在大学时，我曾遇到过一个团队项目中的冲突。我首先邀请大家平静下来，鼓励每个成员依次发言，表达他们的担忧和建议。 For example, during my university years, I encountered a conflict in a team project. I first invited everyone to calm down and encouraged each member to speak in turn, expressing their concerns and suggestions.
>
